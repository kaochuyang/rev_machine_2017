...
bool PTRAFFIC92TC::DoWorkViaPTraffic92(MESSAGEOK message)
{
    try
    {
        ...
        case 0x7A:
            smem.o_Junbo_light.junbol_light_5F7A();//
            break;

        case 0x7D:
            smem.o_Junbo_light.junbol_light_5F7D(message.packet[9]);
...
// need check first
    ...
    /*    stc._for_center_reversetime.usiClearTime    = DataMessageIn.packet[19];//2017 07 01 rev kaochu
